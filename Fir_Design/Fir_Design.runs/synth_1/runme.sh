...
HD_PWD='C:/Xilinx/myproject/Fir_Design/Fir_Design.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_Design.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIR_Design.tcl
