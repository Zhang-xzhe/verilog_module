...
HD_PWD='C:/Xilinx/myproject/Fir_Design/Fir_Design.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_Design.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FIR_Design.tcl -notrace
