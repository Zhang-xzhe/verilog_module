...
REM
REM Generated by Vivado on Wed Mar 30 20:00:36 +0800 2022
...
echo "xvlog --incr --relax -prj tb_FIR_Design_vlog.prj"
call xvlog  --incr --relax -prj tb_FIR_Design_vlog.prj -log xvlog.log
